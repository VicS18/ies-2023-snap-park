        ...
        <div id="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card border-left-info shadow h-100 py-2">
                            <a class="nav-link" href="park1.html">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Park 1</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            </div>
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <a class="nav-link" href="register.html">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Sign Up</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            </div>
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <a class="nav-link" href="forgot-password.html">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Forgot Password</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            </div>
                ...
                <div class="row">
                        ...
                        <div class="card border-left-warning shadow h-100 py-2">
                            <a class="nav-link" href="sensors.html">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Sensors</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#addSensorModal">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#remSensorModal">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/api/v1/park/Jonh" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="latitude" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="longitude" class="col-sm-2 col-form-label">Longitude</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="longitude" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="entranceFee" class="col-sm-2 col-form-label">Fee</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="entranceFee" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="maxLotation" class="col-sm-2 col-form-label">Max Capacity</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="maxLotation" placeholder="">
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <!--<a class="btn btn-primary" href="#.html">Add</a>-->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addSensorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Sensor</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            <label for="inputStreet" class="col-sm-2 col-form-label">SensorBox IP</label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputStreet" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="inputState" class="col-sm-2 col-form-label">Park</label>
                            <div class="form-group col-sm-10">
                                <select class="custom-select" required>
    ...
    <div class="modal fade" id="remSensorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to remove this sensor?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
